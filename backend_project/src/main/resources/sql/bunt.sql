...
ALTER TABLE `ORDERS`
    ADD CONSTRAINT `FK_DELIVERY_TO_ORDERS_1` FOREIGN KEY (`delivery_id`) REFERENCES `DELIVERY` (`delivery_id`);
ALTER TABLE `ORDER_ITEM`
    ADD CONSTRAINT `FK_ORDERS_TO_ORDER_ITEM_1` FOREIGN KEY (`order_id`) REFERENCES `ORDERS` (`order_id`);
ALTER TABLE `ORDER_ITEM`
    ADD CONSTRAINT `FK_ITEM_TO_ORDER_ITEM_1` FOREIGN KEY (`item_id`) REFERENCES `ITEM` (`item_id`);
ALTER TABLE `ITEM`
    ADD CONSTRAINT `FK_TEAM_TO_ITEM_1` FOREIGN KEY (`team_id`) REFERENCES `TEAM` (`team_id`);
ALTER TABLE `REVIEW`
    ADD CONSTRAINT `FK_USERS_TO_REVIEW_1` FOREIGN KEY (`user_id`) REFERENCES `USERS` (`user_id`);
ALTER TABLE `REVIEW`
    ADD CONSTRAINT `FK_ITEM_TO_REVIEW_1` FOREIGN KEY (`item_id`) REFERENCES `ITEM` (`item_id`);
ALTER TABLE `REVIEW_COMMENT`
    ADD CONSTRAINT `FK_USERS_TO_REVIEW_COMMENT_1` FOREIGN KEY (`user_id`) REFERENCES `USERS` (`user_id`);
ALTER TABLE `REVIEW_COMMENT`
    ADD CONSTRAINT `FK_REVIEW_TO_REVIEW_COMMENT_1` FOREIGN KEY (`board_id`) REFERENCES `REVIEW` (`review_id`);
ALTER TABLE `INQUIRY`
    ADD CONSTRAINT `FK_USERS_TO_INQUIRY_1` FOREIGN KEY (`user_id`) REFERENCES `USERS` (`user_id`);
ALTER TABLE `INQUIRY`
    ADD CONSTRAINT `FK_ITEM_TO_INQUIRY_1` FOREIGN KEY (`item_id`) REFERENCES `ITEM` (`item_id`);
ALTER TABLE `INQUIRY_COMMENT`
    ADD CONSTRAINT `FK_USERS_TO_INQUIRY_COMMENT_1` FOREIGN KEY (`user_id`) REFERENCES `USERS` (`user_id`);
ALTER TABLE `INQUIRY_COMMENT`
    ADD CONSTRAINT `FK_INQUIRY_TO_INQUIRY_COMMENT_1` FOREIGN KEY (`board_id`) REFERENCES `INQUIRY` (`inquiry_id`);
ALTER TABLE `CART`
    ADD CONSTRAINT `FK_USERS_TO_CART_1` FOREIGN KEY (`user_id`) REFERENCES `USERS` (`user_id`);
ALTER TABLE `CART`
    ADD CONSTRAINT `FK_ITEM_TO_CART_1` FOREIGN KEY (`item_id`) REFERENCES `ITEM` (`item_id`);
ALTER TABLE `PLAYERS`
    ADD CONSTRAINT `FK_TEAM_TO_PLAYERS_1` FOREIGN KEY (`team_id`) REFERENCES `TEAM` (`team_id`);
ALTER TABLE `ZZIM`
    ADD CONSTRAINT `FK_USERS_TO_ZZIM_1` FOREIGN KEY (`user_id`) REFERENCES `USERS` (`user_id`);
ALTER TABLE `ZZIM`
    ADD CONSTRAINT `FK_ITEM_TO_ZZIM_1` FOREIGN KEY (`item_id`) REFERENCES `ITEM` (`item_id`);
ALTER TABLE `COMMUNITY`
